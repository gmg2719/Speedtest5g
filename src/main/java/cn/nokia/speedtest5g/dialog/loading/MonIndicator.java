...
public class MonIndicator extends View{
	...
	public MonIndicator(Context context, AttributeSet attrs) {
		...
		//获得默认圆的半径
		circleRadius = (int)a.getDimension(R.styleable.monindicator_circleRadius, ConversionUtil.getInstances().getDPtoPx(context,14));
		//获得默认圆的间距
		circleSpacing = (int)a.getDimension(R.styleable.monindicator_circleSpacing, ConversionUtil.getInstances().getDPtoPx(context,5));
